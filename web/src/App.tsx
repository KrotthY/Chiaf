...
function App() {
  return (
    ...
    <div className='content-page'>
      <header className='flex justify-between items-center px-4 py-2 my-2'> 
      ...
      <main className="px-4 mx-auto">
        ...
        <div className="h-96 space-y-5">
          ...
          {/* Card */}
          <div className="flex flex-col bg-slate-100 md:flex-row justify-between h-full  overflow-hidden">
          {/* author */}
              ...
              <div className="relative flex flex-col justify-between h-full p-4 z-10">
                ...
                <div className="flex flex-col justify-end">
                  <p className="md:text-base  lg:text-xl   md:font-semibold xl:font-bold text-white  transition-all duration-300 group-hover:-translate-y-4">
                    Carlos Patricio vidal curumilla
                  </p>
          ...
          <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-6 ">
            ...
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="min-w-[280px] max-w-[300px] flex-shrink-0 rounded-lg bg-white  shadow-md"
              >
                <img
                  alt=""
